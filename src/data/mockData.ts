...
export const mockConcerns: Concern[] = [
  ...
  },
  {
    ...
    solutionLevel: "school",
    replies: [
      createReply("r12a", "pro-argument", "This would make everyone feel more involved in class decisions.", 6, 9),
      createReply("r12b", "objection", "Taking time from lessons might affect our curriculum coverage.", 4, 8.5),
    ],
  },
  {
    id: "3b",
    ...
    group: "Class 9B",
    replies: [
      createReply("r12c", "pro-argument", "It's hard to concentrate when you're freezing or sweating.", 7, 13),
      createReply("r12d", "proposal", "Request maintenance to fix the thermostat and check the HVAC system.", 5, 12),
    ],
  },
  {
    id: "3c",
    ...
    solutionLevel: "school",
    replies: [
      createReply("r12e", "pro-argument", "This would encourage more reading during free time.", 5, 15),
      createReply("r12f", "proposal", "We could do a book drive where everyone brings books from home.", 6, 14.5),
    ],
  },
  {
    id: "3d",
    ...
    group: "Class 10A",
    replies: [
      createReply("r12g", "pro-argument", "I always end up doing everything while others get the same grade.", 4, 19),
      createReply("r12h", "proposal", "Teachers should require individual contribution logs for group projects.", 7, 18),
    ],
  },
  {
    id: "3e",
    ...
    group: "Class 9B",
    replies: [
      createReply("r12i", "pro-argument", "Our bags are piled up and things get lost or damaged.", 3, 21),
      createReply("r12j", "proposal", "Install additional hooks and shelves along the classroom walls.", 4, 20.5),
    ],
  },
  ...
  },
  {
    ...
    solutionLevel: "school",
    replies: [
      createReply("r27a", "pro-argument", "I learn better when studying with peers from other classes.", 11, 27),
      createReply("r27b", "proposal", "Use empty classrooms after school for these study sessions.", 8, 26.5),
    ],
  },
  {
    id: "6b",
    ...
    group: "Grade 11",
    replies: [
      createReply("r27c", "pro-argument", "My friend in another class gets better grades for similar work.", 9, 31),
      createReply("r27d", "objection", "Teachers should have flexibility in their assessment methods.", 6, 30.5),
      createReply("r27e", "proposal", "Create standardized rubrics that all teachers agree to use.", 12, 30, [], undefined, {
  ...
  },
  {
    ...
    solutionLevel: "school",
    replies: [
      createReply("r27f", "pro-argument", "This would help build grade unity and school spirit.", 8, 37),
      createReply("r27g", "objection", "Organizing 300+ students for an assembly takes a lot of time.", 5, 36),
    ],
  },
  {
    id: "6d",
    ...
    group: "Grade 11",
    replies: [
      createReply("r27h", "pro-argument", "I have no idea what I want to study and need more help exploring options.", 7, 41),
      createReply("r27i", "proposal", "Invite professionals from different fields to speak about their careers.", 9, 40),
    ],
  },
  {
    id: "6e",
    ...
    group: "Grade 10",
    replies: [
      createReply("r27j", "pro-argument", "I can't do homework properly without having the textbook at home.", 6, 45),
      createReply("r27k", "proposal", "Create a textbook lending library where students can check out books for the semester.", 8, 44, [], undefined, {
