...
export const mockConcerns: Concern[] = [
  ...
  },
  {
    ...
    problemText: "Group projects often result in unequal workload distribution, with some students doing most of the work while others contribute little.",
    proposalText: "Implement peer evaluation forms where group members rate each other's contributions, affecting individual grades.",
    votes: 12,
