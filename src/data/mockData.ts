...
export const mockConcerns: Concern[] = [
    ...
    variants: [
      {
        ...
        text: "Our current row-by-row seating creates **several problems**:\n- Students in back corners *can't see the board* clearly\n- Group work requires awkward desk rearrangement → wastes class time\n- Students feel *trapped* in the same spot all year\n\nWe propose a **flexible zoning system** with three areas:\n1. *Traditional desk area* near the board for direct instruction\n2. **Collaborative cluster** with grouped desks for project work\n3. *Quiet corner* with individual desks for focused study\n\nStudents rotate through zones based on daily activities. Requires no additional furniture → just reorganization.",
        votes: 5,
      },
      {
        id: "v-c10b-1-2",
        title: "U-Shape Seating with Weekly Rotation and Standing Options",
        text: "Students struggle with visibility and collaboration due to traditional row seating:\n- Back corner students *literally can't read the board* during math\n- Group work requires disruptive desk-moving → wastes **5-10 minutes** per class\n\nWe propose a **comprehensive seating redesign**:\n1. Arrange desks in **U-shape** → all students face board and each other\n2. Implement *weekly seat rotation* → no student permanently disadvantaged\n3. Add **2-3 standing desk stations** for students who focus better standing\n\nThe rotation lottery would be managed by students themselves → teaches fairness and organization. Creates an *equitable, engaging* environment supporting multiple learning styles.",
        votes: 11,
      },
    ],
    replies: [
    ...
    variants: [
      {
        ...
        text: "During independent work, some students chat loudly while others *need silence* to concentrate → creates tension and affects learning outcomes.\n\nWe propose a **traffic light noise system**:\n- 🔴 **Red card** → complete silence required\n- 🟡 *Yellow* → whispered collaboration with neighbors\n- 🟢 **Green** → open discussion time\n\nThis visual system is easy to understand, requires *no technology*, and gives teachers flexibility. Students participate in creating rules → increases buy-in. Respects **both** social learners and those who need quiet.",
        votes: 4,
      },
      {
        id: "v-c10b-2-2",
        title: "Structured Work Time with Designated Zones and Equipment",
        text: "Our classroom has a recurring conflict: social students chat while focused students *can't concentrate* → frustration on both sides.\n\nWe propose **designated zones**:\n- **Silence zone** with noise-canceling headphones available for checkout\n- *Collaboration zone* where quiet discussion is permitted\n\n**Structured time blocks**:\n1. First *15 minutes* → always silent\n2. Following *10 minutes* → optional collaborative time\n\nA student-managed noise monitor tracks disruptions using a simple tally. This respects **different learning styles** while maintaining productivity for everyone.",
        votes: 9,
      },
    ],
    replies: [
    ...
    variants: [
      {
        ...
        text: "Students frequently experience **assignment pile-ups** where 4-5 deadlines fall on the same day → unnecessary stress and lower quality work.\n\nCurrently, each teacher announces homework *independently* with no coordination.\n\nWe propose a **shared Google Calendar**:\n- Teachers spend *30 seconds* entering each assignment\n- Include subject name, brief description, due date\n- Students subscribe for notifications\n- See week's workload *at a glance*\n\nA student volunteer maintains the calendar and sends weekly summaries. This low-tech solution requires **minimal effort** from teachers while dramatically improving organization.",
        votes: 5,
      },
      {
        id: "v-c10b-3-2",
        title: "Integrated Assignment Management System with Workload Balancing",
        text: "Students struggle to manage deadlines across **8 different subjects** → multiple major assignments due simultaneously → all-night study sessions and increased stress.\n\nWe propose a **school-wide digital assignment calendar** integrated with our school portal:\n\n*Mandatory features:*\n- Automatic notifications **3 days** and **1 day** before deadlines\n- *Color-coded workload view* showing assignment density\n- **Load balancing** alerts teachers when scheduling on heavy days\n- Export to phone calendars\n\nThis promotes coordination between teachers and gives students visibility to plan effectively.",
        votes: 8,
      },
    ],
    replies: [
    ...
    variants: [
      {
        ...
        text: "Our science labs have deteriorated to the point where **meaningful experiments are nearly impossible**.\n\nLast week's biology class:\n- Only **2 of 6 microscopes** functional\n- Groups of 8 students shared *one unit*\n- Each student got less than **2 minutes** of viewing time in a 45-minute lab\n\nChemistry equipment equally problematic:\n- Bunsen burners with **gas leaks** (safety hazards!)\n- Half the beakers have *chips* → could cause cuts\n- Missing basics: test tube holders, graduated cylinders\n\nWe propose a **prioritized repair/replacement list**: safety hazards first → then essential instructional equipment.",
        votes: 6,
      },
      {
        id: "v-c10c-1-2",
        title: "Lab Equipment Restoration Program with Multiple Funding Sources",
        text: "Lab equipment has reached a **crisis point** → compromising education quality *and* student safety.\n\nWe propose a **Lab Equipment Restoration Program**:\n\n1. **Phase 1** → Immediate safety audit, retire hazardous equipment\n2. **Phase 2** → Submit prioritized funding request (estimated *€3,000* for essentials)\n3. **Phase 3** → Apply for STEM education grants (teacher identified 3 opportunities)\n4. **Phase 4** → Community fundraiser + local business outreach for donations\n\nMany companies upgrade equipment annually and donate older-but-functional units. This multi-pronged approach maximizes our chances of **restoring functional labs this school year**.",
        votes: 13,
      },
    ],
    replies: [
    ...
    variants: [
      {
        ...
        text: "Current policy treats all late submissions the same → immediate grade penalties *regardless of circumstances*.\n\nThis ignores reality: family emergencies, illness, technology failures, or overwhelming workload when deadlines coincide.\n\nWe propose **2 extension tokens per semester**:\n- Use for *any assignment* without questions or penalties\n- Grants automatic **24-hour extension**\n- Request through simple online form → auto-notifies teacher\n- Unused tokens *don't carry over* (prevents hoarding)\n\nThis provides necessary flexibility while maintaining **structure and accountability** → students must budget extensions wisely.",
        votes: 5,
      },
      {
        id: "v-c10c-2-2",
        title: "Structured Extension System with Teacher Flexibility",
        text: "Students face legitimate obstacles: illness, family emergencies, technology failures, multiple tests on the same day. But our current system applies **identical penalties regardless of circumstances** → unnecessary stress.\n\nWe propose a **structured extension policy**:\n- Request up to *2 extensions per semester per class*\n- Simple form citing reason (no documentation for first request)\n- Teachers approve **24-48 hour** extensions\n- Documented emergencies → *unlimited* extensions\n- Must submit **6 hours before deadline** (prevents last-minute abuse)\n\nThis balances flexibility with accountability → teaches students to communicate *proactively* about obstacles.",
        votes: 10,
      },
    ],
    replies: [
    ...
    variants: [
      {
        ...
        text: "Our **30-minute lunch** is effectively reduced to *10-12 minutes* of actual eating due to extreme lines.\n\nThe problem: **400+ students** in our lunch block try to get food simultaneously.\n\nWe propose **staggered lunch times**:\n- Group A enters at *12:00*\n- Group B at *12:10*\n- Group C at *12:20*\n\nEach group still gets 30 minutes, but serving line handles smaller waves. Requires **no additional staff or equipment** → just schedule coordination.\n\nResult: reasonable wait times and enough time to actually eat a proper meal.",
        votes: 4,
      },
      {
        id: "v-c10c-3-2",
        title: "Cafeteria Efficiency - Multi-Pronged Improvement Plan",
        text: "The cafeteria bottleneck has reached a point where **many students skip lunch** rather than wait. With 400+ students, average wait exceeds *15 minutes* → only 10 minutes to eat → affects nutrition and afternoon performance.\n\nWe propose a **comprehensive efficiency plan**:\n\n1. **Staggered entry** by grade (5-minute intervals) → smooths the flow\n2. Add **grab-and-go station** with pre-packaged healthy options (sandwiches, salads, fruit)\n3. Extend lunch by *5 minutes* (shorten preceding passing period)\n4. Install **digital menu display** → decide before reaching the front\n\nThese combined measures could reduce average wait to **under 5 minutes**.",
        votes: 9,
      },
    ],
    replies: [
  ...
  // Winner 3 from Class 10A - Sports Equipment
  {
    ...
    problemText: "Our physical education program is severely hampered by a **critical shortage of sports equipment**. In a typical 45-minute PE class with 30 students, we have:\n\n- Only **8 basketballs**\n- **4 working** badminton rackets\n- **6 soccer balls** that aren't deflated or damaged\n\nThis means students spend more time *waiting* than actually exercising. During our last basketball unit, some students only touched the ball **twice during the entire class period**.\n\nAdditional equipment issues:\n- Volleyball nets are *torn and unsafe*\n- Gymnastics mats are cracked → inadequate cushioning\n- Half the jump ropes are *missing handles*\n\nThis equipment shortage directly contradicts the school's stated commitment to student health. Students who need physical activity most are often the ones who end up standing on the sidelines.",
    proposalText: "We propose a **three-phase equipment renewal plan**:\n\n1. **Phase 1** (immediate) → Conduct complete inventory of all PE equipment and *immediately retire* anything damaged or unsafe\n2. **Phase 2** (within one month) → Submit prioritized equipment request to administration including costs (estimated **€2,500** for essential items)\n3. **Phase 3** (ongoing) → Implement equipment care program where students learn proper storage and maintenance\n\nAdditional recommendations:\n- Partner with local sports clubs who often have *gently used equipment* they're willing to donate\n- Our PE teacher supports this proposal and has offered to help coordinate with administration",
    votes: 38,
    timestamp: daysAgo(65),
    phase: "grade",
    group: "Grade 10",
  ...
  // Winner 1 from Class 10C - Broken Lab Equipment
  {
    ...
    problemText: "Our school's science laboratories are in a **critical state of disrepair**, significantly impacting the quality of science education for all students.\n\n**Chemistry issues:**\n- Broken Bunsen burners with *faulty gas connections*\n- Cracked beakers that pose safety risks\n- Scales that give inconsistent readings\n\n**Biology crisis:**\n- Of **24 microscopes** in Lab 2, only **8 function properly**\n- 3 of those have broken fine focus knobs\n- Groups of *6-7 students* must share a single working microscope → drastically reduces hands-on learning\n\n**Physics problems:**\n- Most voltmeters show *inaccurate readings*\n- Several missing probes entirely\n\nLast week, a chemistry experiment had to be cancelled when we discovered that half the test tubes were *etched and unsafe* for heating. The science department has submitted repair requests for **over two years**, but budget constraints have prevented any action.",
    proposalText: "We propose an **Emergency Science Equipment Restoration Initiative**:\n\n1. **Safety Audit** → Conduct comprehensive audit within two weeks, tagging items as 'safe,' 'needs repair,' or 'replace immediately'\n2. **Quarantine** → Immediately remove unsafe equipment to prevent accidents\n3. **Grant Applications** → Apply for science education grants from the state (our teacher has identified programs that could provide up to **€15,000**)\n4. **Fundraising** → Establish parent-teacher campaign specifically for lab equipment with *transparent reporting*\n5. **Student Lab Assistants** → Create program where responsible students help maintain equipment, extending lifespan and teaching valuable skills\n\nWe've already drafted a letter to the principal and school board outlining the safety concerns and educational impact.",
    votes: 40,
    timestamp: daysAgo(65),
    phase: "grade",
    group: "Grade 10",
  ...
  // Winner 2 from Class 10C - Flexible Deadlines
  {
    ...
    problemText: "The current **rigid deadline system** creates unnecessary stress and doesn't account for the complex realities of students' lives. Many of us juggle:\n\n- School with *extracurricular activities*\n- Family responsibilities\n- Part-time jobs\n- Mental health challenges\n\nWhen multiple major assignments coincide—which happens frequently because teachers *don't coordinate* due dates—students face impossible choices.\n\n**Example:** Last month, I had *two essays*, a lab report, and a math project all due within **48 hours**. Despite starting early, I couldn't complete everything to my best ability.\n\nThe all-or-nothing approach means a student who submits *mediocre work on time* gets a better grade than one who could have submitted **excellent work** with just one extra day. This doesn't reflect real-world professional environments where reasonable deadline adjustments are normal.\n\nFurthermore, rigid deadlines contribute to → anxiety, sleep deprivation, and in some cases, *academic dishonesty* as desperate students see no other option.",
    proposalText: "We propose a **Flexible Deadline Policy** with clear guidelines to prevent abuse while supporting students who genuinely need flexibility:\n\n**Extension Token System:**\n- Each student gets **3 'extension tokens'** per semester\n- Each token = **24-hour extension**\n- Claimed through simple online form → *no justification required*\n- Additional extensions require teacher approval with brief explanation\n\n**Limitations:**\n- Cannot be used for *final exams* or in-class presentations\n\n**Teacher Coordination:**\n- Shared calendar showing major due dates across all subjects\n- Encourages teachers to coordinate and *avoid deadline pile-ups*\n\nThis system respects student autonomy, reduces stress, and teaches time management through limited resources rather than rigid rules.",
    votes: 36,
    timestamp: daysAgo(65),
    phase: "grade",
    group: "Grade 10",
  ...
  // Winner from Grade 11 - Mental Health Support
  {
    ...
    problemText: "Our school faces a **mental health crisis** that has been largely invisible until now. Based on anonymous surveys conducted by our student council:\n\n- Over **40%** of students report significant stress or anxiety related to school\n- **25%** have considered seeking professional mental health support but *didn't know how*\n- **15%** report symptoms consistent with depression\n\n**Current Resources are Inadequate:**\n- Only **2 counselors** for over **800 students** → ratio of **1:400**\n- Recommended ratio is *1:250*\n- Average wait time to see a counselor: **3 weeks**\n\nBy this point, many students have either struggled through alone or *given up trying to get help*. There's also significant stigma—students fear being labeled or having parents notified.\n\nThe COVID-19 pandemic has made things worse: increased isolation, uncertainty about the future, and academic pressure. Teachers report noticing more students struggling but feeling *unequipped to help*.",
    proposalText: "We propose a comprehensive **Mental Health Support Initiative** with multiple components working together:\n\n1. **Additional Counselor** → Advocate for hiring one additional school counselor to improve ratio to *1:270*\n2. **Peer Support Network** → Train student volunteers with **20 hours** of mental health first aid certification to serve as first-point contacts\n3. **Community Partnerships** → Partner with local mental health organizations (we've already contacted *three who are interested*) for free monthly workshops and crisis support\n4. **Wellness Room** → Create a quiet, calm space students can visit during free periods when feeling overwhelmed\n5. **Curriculum Integration** → Include mental health education in existing health classes covering stress management, warning signs, and help-seeking\n6. **Anonymous Check-ins** → Implement wellness check-ins *twice per semester* through an app, with counselors following up on concerning responses\n7. **Teacher Training** → Provide basic mental health awareness training so teachers can better recognize students in distress\n\nThis multi-layered approach ensures support is accessible, reduces stigma, and *catches problems early*.",
    votes: 72,
    timestamp: daysAgo(30),
    phase: "school",
    group: "Whole School",
  ...
  // Additional school phase concern - Sustainability
  {
    ...
    problemText: "Our school's environmental impact is significant and **largely unaddressed**.\n\n**Recycling Failure:**\n- Blue bins exist but are *rarely emptied separately* from regular trash\n- Current system is \"recycling theater\" rather than reality\n\n**Energy Waste:**\n- Lights left on in *empty classrooms*\n- Computers run **24/7**\n- Heating at full capacity even during mild weather → no programmable thermostat\n\n**Plastics & Paper:**\n- Single-use plastics everywhere (cafeteria utensils, vending machine bottles)\n- Teachers print *hundreds of sheets daily* for assignments that could be digital\n\n**The Impact:**\n- School produces **50+ tons** of waste annually\n- Uses **40% more energy** than comparable modern schools\n- Virtually *no sustainability practices*\n\nThis contradicts everything we're learning about climate change in science class.",
    proposalText: "We propose a phased **School-Wide Sustainability Initiative**:\n\n**Phase 1** (immediate, *no cost*):\n- Establish student-led **Green Team** with representatives from each grade\n- Implement proper recycling with clearly labeled bins and student monitors\n- Create 'energy patrol' to turn off lights/equipment in empty rooms\n\n**Phase 2** (within 3 months, *low cost*):\n- Replace cafeteria single-use plastics with compostable alternatives → **€500/year**\n- Start composting program for food waste, partnering with local community garden\n- Launch digital-first policy to reduce printing\n\n**Phase 3** (within 1 year, *investment required*):\n- Apply for government green school grants for LED lighting retrofit (typical payback: 2 years)\n- Install programmable thermostats → **€2,000 investment**, **€3,000 annual savings**\n- Create outdoor environmental education area\n\nSimilar programs at other schools typically save **25-35%** on utility costs within 3 years, making this financially beneficial as well as environmentally responsible.",
    votes: 58,
    timestamp: daysAgo(30),
    phase: "school",
    group: "Whole School",
