...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: "Discussions progress through 3 phases: Class → Grade → School. Each phase expands the audience and refines the best ideas. After completion, a new interval begins.",
    position: "bottom",
    route: "/",
  },
  {
    id: "review-phase",
    targetSelector: '[data-tour="review-phase"]',
    title: "Review Phase",
    description: "Between each phase, there's a 5-day review period where the community votes on the best proposal variants. The top-voted solutions advance to the next phase.",
    position: "bottom",
    route: "/",
  },
  {
  ...
  },
  {
    ...
    description: "Use the Ban icon to raise an objection if you see a significant flaw. Constructive objections should be specific and actionable. You can also append a counter-proposal that addresses the issue.",
    position: "top",
    mobilePosition: "bottom",
    route: "/concern/c10a-1",
    action: "closeForm",
  },
  {
    ...
    description: "Replies are organized into tabs: Responses for endorsements and objections, Q&A for questions and answers. You can also filter and sort responses to find what matters most.",
    position: "top",
    mobilePosition: "bottom",
    route: "/concern/c10a-1",
    action: "closeForm",
